...
class UNet(nn.Module):
    def __init__(self, ngf=8):
        ...
        self.up_conv4 = nn.Conv1d(ngf*16, ngf*8, kernel_size=2, dilation=2, padding="same")
        self.up_conv3 = nn.Conv1d(ngf*8, ngf*4, kernel_size=2,dilation=2, padding="same")
        self.up_conv2 = nn.Conv1d(ngf*4, ngf*2, kernel_size=2, dilation=2,padding="same")
        self.up_conv1 = nn.Conv1d(ngf*2, ngf, kernel_size=2, dilation=2, padding="same")
